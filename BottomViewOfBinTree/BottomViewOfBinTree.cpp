// BottomViewOfBinTree.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void ProcessNode(Node* root, int index, std::map<int, Node*>& m)
{
    ...
    // if index exists, overwrite it with its lower level
    m[index] = root;
